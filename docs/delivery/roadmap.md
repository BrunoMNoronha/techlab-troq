...
- Observabilidade básica: logs estruturados e rastreamento de erros, sem dados protegidos (RNF-018). A **ferramenta e o escopo** foram decididos por [../adr/0007-observability-sentry.md](../adr/0007-observability-sentry.md) (DEC-039, F1-008): Sentry SaaS, um projeto e um DSN por ambiente, Session Replay fora do MVP. O **entregável** continua sendo a observabilidade em operação, que a decisão não substitui.
