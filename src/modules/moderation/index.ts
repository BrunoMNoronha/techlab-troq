// Modulo de dominio `moderation` (docs/architecture/overview.md, AR-3.3).
//
// Responsabilidade: Denuncia, decisao, sancao, contestacao.
// Entidades proprias (docs/architecture/data-model.md): `Report`, `ModerationDecision`, `Sanction`, `Appeal`.
//
...
// externos importam `@/modules/moderation`; nunca um caminho interno do modulo.
//
