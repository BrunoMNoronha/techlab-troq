...
- Observabilidade básica: logs estruturados e rastreamento de erros, sem dados protegidos (RNF-018). A **ferramenta e o escopo** foram decididos por [../adr/0007-observability-sentry.md](../adr/0007-observability-sentry.md) (DEC-039, F1-008): Sentry SaaS, um projeto e um DSN por ambiente, Session Replay fora do MVP; e os projetos de `development` e `preview` foram **provisionados** por F1-009. O **entregável** continua sendo a observabilidade em operação, que nem a decisão nem o provisionamento substituem.
