...
| [delivery/backlog.md](delivery/backlog.md) | existente | Backlog de alto nível por fase. Todos os itens `F0-xxx` estão concluídos e a Fase 0 foi encerrada em 2026-09-14; a numeração `F1-xxx` foi aberta por F1-001, o primeiro trabalho da Fase 1; F1-001 a F1-003 estão concluídos e F1-004 está em andamento |
