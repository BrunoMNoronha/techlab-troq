...
F0-011 foi **concluído** em 2026-09-14 e fechou OD-08 com [ADR-0004](../adr/0004-mercado-pago-pix.md) (DEC-036): o Mercado Pago deixou de ser candidato e passou a ser o **gateway Pix inicial homologado** do MVP, por Checkout Transparente via Orders API. Com isso, o item `próximo` passa a ser **F0-019**, cuja única dependência era F0-011. A cadeia restante avança um elo: F0-022 depende de F0-019 e F0-023 de F0-022. **OD-07 continua aberta** e é a última decisão aberta da Fase 0.
...
| F0-019 | Definir tratamento de exceções de pagamento | Fechar OD-07: chargebacks, duplicidade, pagamento após expiração da reserva, falhas de confirmação; atualizar RF-009 a RF-012. A dependência F0-011 foi satisfeita e o gateway homologado em [ADR-0004](../adr/0004-mercado-pago-pix.md) é a base concreta destas decisões | F0-011 | próximo |
...
| F0-022 | Produzir arquitetura de dados e API pré-implementação | `architecture/overview.md`, `architecture/data-model.md`, `architecture/payments-design.md` e `architecture/contact-release.md`, com base nas decisões fechadas | F0-011, F0-012, F0-013, F0-014, F0-015, F0-018, F0-019, F0-020, F0-024 | bloqueado (resta apenas F0-019) |
...
Com OD-08 fechada, **OD-07 é a única decisão aberta da Fase 0** e **F0-019** passa a `próximo`.
