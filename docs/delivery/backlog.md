...
Com a conclusão de F0-010, o backlog volta a ter um item `próximo`: **F0-011**, que registra o resultado do spike e fecha OD-08. A cadeia bloqueada permanece, agora um elo adiante: F0-019 por F0-011; F0-022 por F0-011 e F0-019; e F0-023 por F0-022. OD-08 continua **aberta** até que F0-011 seja executado — a conclusão do spike prova viabilidade técnica, não decide o gateway.
...
| F0-011 | Registrar resultado e decisão do gateway | Documentar evidências do spike, fechar OD-08 com ADR-0004 e atualizar decision log, riscos e requisitos RF-011 e RF-012 | F0-010 | próximo |
...
Com dez de dez critérios comprovados, F0-010 está `concluído`, F0-011 passa a `próximo` e a validação técnica deixa de ser o bloqueio da Fase 0. **OD-08 continua aberta**: o spike prova que o Mercado Pago é tecnicamente viável para o caso de uso, mas a escolha do gateway só se fecha em F0-011, com ADR-0004. Até lá, o Mercado Pago permanece apenas candidato (DEC-017). Todas as decisões de produto que não dependiam de pagamento já haviam sido fechadas (OD-01 a OD-06 e OD-09 a OD-12).
