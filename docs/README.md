...
| [delivery/spikes/f0-010-mercado-pago-pix-r099.md](delivery/spikes/f0-010-mercado-pago-pix-r099.md) | existente | Evidências das três execuções do spike F0-010 do gateway Pix para exatamente R$ 0,99 (Mercado Pago); classificação `INCONCLUSIVO`, com 8 de 10 critérios comprovados na terceira execução e OD-08 ainda aberta |
