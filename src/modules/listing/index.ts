// Modulo de dominio `listing` (docs/architecture/overview.md, AR-3.3).
//
// Responsabilidade: Anuncio, ciclo de vida, localizacao publica.
// Entidades proprias (docs/architecture/data-model.md): `Listing`, `ListingTransition`.
//
...
// externos importam `@/modules/listing`; nunca um caminho interno do modulo.
//
